...
$query=Get-WmiObject win32_operatingsystem -ComputerName $Server | select csname, @{LABEL=’LastBootUpTime’;EXPRESSION={$_.ConverttoDateTime($_.lastbootuptime)}} |Export-csv C:\scripts\
}
